...
#pragma region 애니메이션
		...
		std::shared_ptr<Texture> atlas
			= Resources::Load<Texture>(L"Dog_Idle", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_IDLE.png");
		...
		atlas
			= Resources::Load<Texture>(L"Dog_Walk", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_WALK.png");
		...
		//atlas
		//	= Resources::Load<Texture>(L"Dog_Run", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_RUN.png");
		//at->Create(L"R_Run", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 7);
		//at->Create(L"L_Run", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 7);

		atlas
			= Resources::Load<Texture>(L"Dog_Run", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_WALK.png");
		at->Create(L"R_Run", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 6);
		at->Create(L"L_Run", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 6);

		atlas
			= Resources::Load<Texture>(L"Dog_Attacked1", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_ATTACKED1.png");
		...
		atlas
			= Resources::Load<Texture>(L"Dog_Attacked2", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_ATTACKED2.png");
		...
		atlas
			= Resources::Load<Texture>(L"Dog_Attacked3", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_ATTACKED3.png");
		...
		atlas
			= Resources::Load<Texture>(L"Dog_Attacked4", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_ATTACKED4.png");
		...
		atlas
			= Resources::Load<Texture>(L"Dog_GetUp", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_GETUP.png");
		at->Create(L"R_GetUp", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 5, Vector2::Zero, 0.08f);
		at->Create(L"L_GetUp", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 5, Vector2::Zero, 0.08f);

		atlas
			= Resources::Load<Texture>(L"Dog_Downed", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_DEAD.png");
		...
		atlas
			= Resources::Load<Texture>(L"Dog_Dead", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\DOG\\DOG_DEAD.png");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		at->StartEvent(L"L_Attacked1") = std::bind(&DogScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked1") = std::bind(&DogScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked2") = std::bind(&DogScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked2") = std::bind(&DogScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked3") = std::bind(&DogScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked3") = std::bind(&DogScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked4") = std::bind(&DogScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked4") = std::bind(&DogScript::AttackedStart, this);
		at->CompleteEvent(L"L_Attacked1") = std::bind(&DogScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked1") = std::bind(&DogScript::Attacked1Complete, this);
		at->CompleteEvent(L"L_Attacked2") = std::bind(&DogScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked2") = std::bind(&DogScript::Attacked1Complete, this);
		//at->CompleteEvent(L"L_Attacked3") = std::bind(&DogScript::Attacked1Complete, this);
		//at->CompleteEvent(L"R_Attacked3") = std::bind(&DogScript::Attacked1Complete, this);
		at->CompleteEvent(L"L_Attacked4") = std::bind(&DogScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked4") = std::bind(&DogScript::Attacked1Complete, this);

		at->CompleteEvent(L"L_Attacked3") = std::bind(&DogScript::Attacked3Complete, this);
		at->CompleteEvent(L"R_Attacked3") = std::bind(&DogScript::Attacked3Complete, this);
		at->CompleteEvent(L"L_Attacked4") = std::bind(&DogScript::Attacked4Complete, this);
		at->CompleteEvent(L"R_Attacked4") = std::bind(&DogScript::Attacked4Complete, this);

		at->CompleteEvent(L"L_Downed") = std::bind(&DogScript::DownedComplete, this);
		at->CompleteEvent(L"R_Downed") = std::bind(&DogScript::DownedComplete, this);

		at->CompleteEvent(L"L_GetUp") = std::bind(&DogScript::GetUpComplete, this);
		at->CompleteEvent(L"R_GetUp") = std::bind(&DogScript::GetUpComplete, this);
...
#pragma region OnCollision
	...
	void DogScript::OnCollisionEnter(Collider2D* other)
	{

	}

	void DogScript::OnCollisionStay(Collider2D* other)
	{
	...
	void DogScript::OnCollisionExit(Collider2D* other)
	{
...
#pragma region 이벤트 함수
	...
	void DogScript::GuardComplete()
	{

	}

	void DogScript::Attacked1Complete()
	{
		mIsAttacked1 = false;
		mIsAttacked2 = false;
		//mIsAttacked3 = false;
	...
	void DogScript::Attacked3Complete()
	{
		mIsAttacked3 = false;
		mIsDowned = true;
	...
	void DogScript::Attacked4Complete()
	{
		mIsAttacked4 = false;
		mIsDowned = true;
...
#pragma region 애니메이션 함수
	...
	void DogScript::L_idle()
	{
		Animator* at = this->GetOwner()->GetComponent<Animator>();
		at->PlayAnimation(L"L_Idle", true);
	}
	void DogScript::R_idle()
	{
		Animator* at = this->GetOwner()->GetComponent<Animator>();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void DogScript::SetAttackedState()
	{
		// 플레이어 공격 스킬 확인
...
#pragma endregion
	...
	void DogScript::SetEffectFlickering(float tick, float duration)
	{
		GetOwner()->mIsEffectFlickering = true;
		mOnFlickering = true;
		mFlickeringCurTime = 0.0f;
	...
	void DogScript::SetEffectFlashing(float tick, float duration, Vector4 color)
	{
		GetOwner()->mIsEffectFlashing = true;
