...
#pragma region 애니메이션
		...
		std::shared_ptr<Texture> atlas
			= Resources::Load<Texture>(L"Jesse_Idle", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_IDLE.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_Walk", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_WALK.png");
		at->Create(L"R_Walk", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 6);
		at->Create(L"L_Walk", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 6);

		atlas
			= Resources::Load<Texture>(L"Jesse_Run", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_RUN.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_ArmAttack", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_ARM.png");
		at->Create(L"R_ArmAttack", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 7);
		at->Create(L"L_ArmAttack", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 7);

		atlas
			= Resources::Load<Texture>(L"Jesse_KickAttack", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_KICK.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_SideKickAttack", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_SIDEKICK.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_UpperAttack", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_UPPER.png");
		at->Create(L"R_UpperAttack", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 8);
		at->Create(L"L_UpperAttack", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 8);

		atlas
			= Resources::Load<Texture>(L"Jesse_Guard", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_GUARD.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_Attacked1", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_ATTACKED1.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_Attacked2", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_ATTACKED2.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_Attacked3", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_ATTACKED3.png");
		at->Create(L"R_Attacked3", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 12);
		at->Create(L"L_Attacked3", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 12);

		atlas
			= Resources::Load<Texture>(L"Jesse_Attacked4", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_ATTACKED4.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_GetUp", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_GETUP.png");
		at->Create(L"R_GetUp", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 9, Vector2::Zero, 0.08f);
		at->Create(L"L_GetUp", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 9, Vector2::Zero, 0.08f);

		atlas
			= Resources::Load<Texture>(L"Jesse_Downed", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_DEAD.png");
		...
		atlas
			= Resources::Load<Texture>(L"Jesse_Dead", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\JESSE\\JESSE_DEAD.png");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		at->StartEvent(L"L_Attacked1") = std::bind(&JesseScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked1") = std::bind(&JesseScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked2") = std::bind(&JesseScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked2") = std::bind(&JesseScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked3") = std::bind(&JesseScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked3") = std::bind(&JesseScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked4") = std::bind(&JesseScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked4") = std::bind(&JesseScript::AttackedStart, this);
		at->CompleteEvent(L"L_Attacked1") = std::bind(&JesseScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked1") = std::bind(&JesseScript::Attacked1Complete, this);
		at->CompleteEvent(L"L_Attacked2") = std::bind(&JesseScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked2") = std::bind(&JesseScript::Attacked1Complete, this);
		//at->CompleteEvent(L"L_Attacked3") = std::bind(&JesseScript::Attacked1Complete, this);
		//at->CompleteEvent(L"R_Attacked3") = std::bind(&JesseScript::Attacked1Complete, this);
		at->CompleteEvent(L"L_Attacked4") = std::bind(&JesseScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked4") = std::bind(&JesseScript::Attacked1Complete, this);

		at->CompleteEvent(L"L_Attacked3") = std::bind(&JesseScript::Attacked3Complete, this);
		at->CompleteEvent(L"R_Attacked3") = std::bind(&JesseScript::Attacked3Complete, this);
		at->CompleteEvent(L"L_Attacked4") = std::bind(&JesseScript::Attacked4Complete, this);
		at->CompleteEvent(L"R_Attacked4") = std::bind(&JesseScript::Attacked4Complete, this);

		at->StartEvent(L"L_ArmAttack") = std::bind(&JesseScript::AttackStart, this);
		at->StartEvent(L"R_ArmAttack") = std::bind(&JesseScript::AttackStart, this);
		at->StartEvent(L"L_KickAttack") = std::bind(&JesseScript::AttackStart, this);
		at->StartEvent(L"R_KickAttack") = std::bind(&JesseScript::AttackStart, this);
		at->StartEvent(L"L_SideKickAttack") = std::bind(&JesseScript::AttackStart, this);
		at->StartEvent(L"R_SideKickAttack") = std::bind(&JesseScript::AttackStart, this);
		at->StartEvent(L"L_UpperAttack") = std::bind(&JesseScript::AttackStart, this);
		at->StartEvent(L"R_UpperAttack") = std::bind(&JesseScript::AttackStart, this);
		at->CompleteEvent(L"L_ArmAttack") = std::bind(&JesseScript::CombatComplete, this);
		at->CompleteEvent(L"R_ArmAttack") = std::bind(&JesseScript::CombatComplete, this);
		at->CompleteEvent(L"L_KickAttack") = std::bind(&JesseScript::CombatComplete, this);
		at->CompleteEvent(L"R_KickAttack") = std::bind(&JesseScript::CombatComplete, this);
		at->CompleteEvent(L"L_SideKickAttack") = std::bind(&JesseScript::CombatComplete, this);
		at->CompleteEvent(L"R_SideKickAttack") = std::bind(&JesseScript::CombatComplete, this);
		at->CompleteEvent(L"L_UpperAttack") = std::bind(&JesseScript::CombatComplete, this);
		at->CompleteEvent(L"R_UpperAttack") = std::bind(&JesseScript::CombatComplete, this);

		at->CompleteEvent(L"L_Guard") = std::bind(&JesseScript::GuardComplete, this);
		at->CompleteEvent(L"R_Guard") = std::bind(&JesseScript::GuardComplete, this);

		at->CompleteEvent(L"L_Downed") = std::bind(&JesseScript::DownedComplete, this);
		at->CompleteEvent(L"R_Downed") = std::bind(&JesseScript::DownedComplete, this);

		at->CompleteEvent(L"L_GetUp") = std::bind(&JesseScript::GetUpComplete, this);
		at->CompleteEvent(L"R_GetUp") = std::bind(&JesseScript::GetUpComplete, this);
...
#pragma region OnCollision
	...
	void JesseScript::OnCollisionEnter(Collider2D* other)
	{

	}

	void JesseScript::OnCollisionStay(Collider2D* other)
	{
	...
	void JesseScript::OnCollisionExit(Collider2D* other)
	{
...
#pragma region 이벤트 함수
	...
	void JesseScript::CombatComplete()
	{
		mIsArm = false;
		mIsKick = false;
		mIsSideKick = false;
	...
	void JesseScript::GuardComplete()
	{
	...
	void JesseScript::Attacked1Complete()
	{
		mIsAttacked1 = false;
		mIsAttacked2 = false;
		//mIsAttacked3 = false;
	...
	void JesseScript::Attacked3Complete()
	{
		mIsAttacked3 = false;
		mIsDowned = true;
	...
	void JesseScript::Attacked4Complete()
	{
		mIsAttacked4 = false;
		mIsDowned = true;
	...
	void JesseScript::DownedComplete()
	{
		if (mHp <= 0.0f)
		{
			mIsDead = true;
	...
	void JesseScript::GetUpComplete()
	{
		mIsGetUp = false;
	...
	void JesseScript::AttackedStart()
	{
		if (mIsDowned == true)
		{
...
#pragma region 애니메이션 함수
	...
	void JesseScript::L_idle()
	{
		Animator* at = this->GetOwner()->GetComponent<Animator>();
		at->PlayAnimation(L"L_Idle", true);
	}
	void JesseScript::R_idle()
	{
		Animator* at = this->GetOwner()->GetComponent<Animator>();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void JesseScript::SetAttackedState()
	{
		// 플레이어 공격 스킬 확인
...
#pragma endregion
	...
	void JesseScript::SetEffectFlickering(float tick, float duration)
	{
		GetOwner()->mIsEffectFlickering = true;
		mOnFlickering = true;
		mFlickeringCurTime = 0.0f;
	...
	void JesseScript::SetEffectFlashing(float tick, float duration, Vector4 color)
	{
		GetOwner()->mIsEffectFlashing = true;
