...
#pragma region 애니메이션
		...
		std::shared_ptr<Texture> atlas
			= Resources::Load<Texture>(L"Linus_Idle", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_IDLE.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_Walk", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_WALK.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_Run", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_RUN.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_ArmAttack", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_ARM.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_KickAttack", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_KICK.png");
		at->Create(L"R_KickAttack", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 6);
		at->Create(L"L_KickAttack", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 6);

		atlas
			= Resources::Load<Texture>(L"Linus_SideKickAttack", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_SIDEKICK.png");
		at->Create(L"R_SideKickAttack", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 9);
		at->Create(L"L_SideKickAttack", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 9);

		atlas
			= Resources::Load<Texture>(L"Linus_UpperAttack", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_UPPER.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_Guard", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_GUARD.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_Attacked1", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_ATTACKED1.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_Attacked2", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_ATTACKED2.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_Attacked3", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_ATTACKED3.png");
		at->Create(L"R_Attacked3", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 17);
		at->Create(L"L_Attacked3", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 17);

		atlas
			= Resources::Load<Texture>(L"Linus_Attacked4", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_ATTACKED4.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_GetUp", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_GETUP.png");
		at->Create(L"R_GetUp", atlas, eAnimationType::Front, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 10, Vector2::Zero, 0.08f);
		at->Create(L"L_GetUp", atlas, eAnimationType::Back, Vector2(0.0f, 0.0f), Vector2(0.0f, 0.0f), 10, Vector2::Zero, 0.08f);

		atlas
			= Resources::Load<Texture>(L"Linus_Downed", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_DEAD.png");
		...
		atlas
			= Resources::Load<Texture>(L"Linus_Dead", L"..\\Resources\\TEXTURE\\STAGE01\\ENEMY\\LINUS\\LINUS_DEAD.png");
...
#pragma region 이벤트
		...
		at->StartEvent(L"L_Attacked1") = std::bind(&LinusScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked1") = std::bind(&LinusScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked2") = std::bind(&LinusScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked2") = std::bind(&LinusScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked3") = std::bind(&LinusScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked3") = std::bind(&LinusScript::AttackedStart, this);
		at->StartEvent(L"L_Attacked4") = std::bind(&LinusScript::AttackedStart, this);
		at->StartEvent(L"R_Attacked4") = std::bind(&LinusScript::AttackedStart, this);
		at->CompleteEvent(L"L_Attacked1") = std::bind(&LinusScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked1") = std::bind(&LinusScript::Attacked1Complete, this);
		at->CompleteEvent(L"L_Attacked2") = std::bind(&LinusScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked2") = std::bind(&LinusScript::Attacked1Complete, this);
		//at->CompleteEvent(L"L_Attacked3") = std::bind(&LinusScript::Attacked1Complete, this);
		//at->CompleteEvent(L"R_Attacked3") = std::bind(&LinusScript::Attacked1Complete, this);
		at->CompleteEvent(L"L_Attacked4") = std::bind(&LinusScript::Attacked1Complete, this);
		at->CompleteEvent(L"R_Attacked4") = std::bind(&LinusScript::Attacked1Complete, this);

		at->CompleteEvent(L"L_Attacked3") = std::bind(&LinusScript::Attacked3Complete, this);
		at->CompleteEvent(L"R_Attacked3") = std::bind(&LinusScript::Attacked3Complete, this);
		at->CompleteEvent(L"L_Attacked4") = std::bind(&LinusScript::Attacked4Complete, this);
		at->CompleteEvent(L"R_Attacked4") = std::bind(&LinusScript::Attacked4Complete, this);

		at->StartEvent(L"L_ArmAttack") = std::bind(&LinusScript::AttackStart, this);
		at->StartEvent(L"R_ArmAttack") = std::bind(&LinusScript::AttackStart, this);
		at->StartEvent(L"L_KickAttack") = std::bind(&LinusScript::AttackStart, this);
		at->StartEvent(L"R_KickAttack") = std::bind(&LinusScript::AttackStart, this);
		at->StartEvent(L"L_SideKickAttack") = std::bind(&LinusScript::AttackStart, this);
		at->StartEvent(L"R_SideKickAttack") = std::bind(&LinusScript::AttackStart, this);
		at->StartEvent(L"L_UpperAttack") = std::bind(&LinusScript::AttackStart, this);
		at->StartEvent(L"R_UpperAttack") = std::bind(&LinusScript::AttackStart, this);
		at->CompleteEvent(L"L_ArmAttack") = std::bind(&LinusScript::CombatComplete, this);
		at->CompleteEvent(L"R_ArmAttack") = std::bind(&LinusScript::CombatComplete, this);
		at->CompleteEvent(L"L_KickAttack") = std::bind(&LinusScript::CombatComplete, this);
		at->CompleteEvent(L"R_KickAttack") = std::bind(&LinusScript::CombatComplete, this);
		at->CompleteEvent(L"L_SideKickAttack") = std::bind(&LinusScript::CombatComplete, this);
		at->CompleteEvent(L"R_SideKickAttack") = std::bind(&LinusScript::CombatComplete, this);
		at->CompleteEvent(L"L_UpperAttack") = std::bind(&LinusScript::CombatComplete, this);
		at->CompleteEvent(L"R_UpperAttack") = std::bind(&LinusScript::CombatComplete, this);

		at->CompleteEvent(L"L_Guard") = std::bind(&LinusScript::GuardComplete, this);
		at->CompleteEvent(L"R_Guard") = std::bind(&LinusScript::GuardComplete, this);

		at->CompleteEvent(L"L_Downed") = std::bind(&LinusScript::DownedComplete, this);
		at->CompleteEvent(L"R_Downed") = std::bind(&LinusScript::DownedComplete, this);

		at->CompleteEvent(L"L_GetUp") = std::bind(&LinusScript::GetUpComplete, this);
		at->CompleteEvent(L"R_GetUp") = std::bind(&LinusScript::GetUpComplete, this);
...
#pragma region OnCollision
	...
	void LinusScript::OnCollisionEnter(Collider2D* other)
	{

	}

	void LinusScript::OnCollisionStay(Collider2D* other)
	{
	...
	void LinusScript::OnCollisionExit(Collider2D* other)
	{
...
#pragma region 이벤트 함수
	...
	void LinusScript::CombatComplete()
	{
		mIsArm = false;
		mIsKick = false;
		mIsSideKick = false;
	...
	void LinusScript::GuardComplete()
	{
	...
	void LinusScript::Attacked1Complete()
	{
		mIsAttacked1 = false;
		mIsAttacked2 = false;
		//mIsAttacked3 = false;
	...
	void LinusScript::Attacked3Complete()
	{
		mIsAttacked3 = false;
		mIsDowned = true;
	...
	void LinusScript::Attacked4Complete()
	{
		mIsAttacked4 = false;
		mIsDowned = true;
	...
	void LinusScript::DownedComplete()
	{
		if (mHp <= 0.0f)
		{
			mIsDead = true;
	...
	void LinusScript::GetUpComplete()
	{
		mIsGetUp = false;
	...
	void LinusScript::AttackedStart()
	{
		if (mIsDowned == true)
		{
...
#pragma region 애니메이션 함수
	...
	void LinusScript::L_idle()
	{
		Animator* at = this->GetOwner()->GetComponent<Animator>();
		at->PlayAnimation(L"L_Idle", true);
	}
	void LinusScript::R_idle()
	{
		Animator* at = this->GetOwner()->GetComponent<Animator>();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void LinusScript::SetAttackedState()
	{
		// 플레이어 공격 스킬 확인
...
#pragma endregion
	...
	void LinusScript::SetEffectFlickering(float tick, float duration)
	{
		GetOwner()->mIsEffectFlickering = true;
		mOnFlickering = true;
		mFlickeringCurTime = 0.0f;
	...
	void LinusScript::SetEffectFlashing(float tick, float duration, Vector4 color)
	{
		GetOwner()->mIsEffectFlashing = true;
